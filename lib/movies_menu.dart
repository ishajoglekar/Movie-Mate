...
class MoviesMenu extends StatefulWidget {
  MoviesMenu({Key key, this.title, this.active}) : super(key: key);

  final String title;
  final String active;

  @override
  _MoviesMenuState createState() => _MoviesMenuState();
}

class _MoviesMenuState extends State<MoviesMenu> {
  Widget _homeButton() {
    return InkWell(
      onTap: () {
        Navigator.push(
